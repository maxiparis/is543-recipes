...
struct DefaultRecipesManager {
    ...
    func createDefaultData() {
        ...
        recipeGenerator(
            ...
            instructions: [
                Instruction(order: 1, title: "First title", descriptions: "This is some descriptions"),
                Instruction(order: 2, title: "Second title", descriptions: "This more crazy descriptions"),
            ],
            recipe: Recipe(
                name: "Pan con Palta",
